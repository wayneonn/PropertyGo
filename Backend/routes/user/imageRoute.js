...
const { getImagesByPropertyId, getImageById, 
    removeImageById, updateImageById, createImageWithPropertyId, getImagesByPartner
} = require('../../controllers/user/imageController'); // Import the image controller
...
router.get('/getImagesByPartnerId/:id', getImagesByPartner)
