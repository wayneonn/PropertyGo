...
const { getTransactions, getTopTenTransactions, getTransactionValueByLastSixMonths, getTransactionValueByBuyerId,
    ...
    sellerCancelledOTP, buyerPaidOptionExerciseFee, getTransactionAdmin
...
router.post("/transactions/buyerPaidOptionExerciseFee/:transactionId", buyerPaidOptionExerciseFee)
