...
exports.buyerUploadedOTP = async (req, res) => {
    ...
    try {
        ...
        const content = `${buyer.userName.charAt(0).toUpperCase() + buyer.userName.slice(1)} has uploaded the OTP Document for the property ${property.title}. Please upload the Option to Purchase (OTP) to complete the transaction.`;
