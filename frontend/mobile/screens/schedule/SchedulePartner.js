...
const SchedulePartner = ({ route }) => {
    // Get schedule by Chat ID.
    // Also, should we look for schedule conflicts?
    const { chatId, userDetails } = route.params;
        ...
        <View style={styles.container}>
            ...
            >
                <View style={styles.headerContainer}>
                    ...
                    <Text style={styles.header}>Book Partner Viewing</Text>
                </View>
...
export default SchedulePartner;
