...
import { updateForumCommentFlaggedStatus, deleteForumComment, getAllUserDownvotedForumComment} from '../../utils/forumCommentApi';
import { getAllForumPostById } from '../../utils/forumPostApi';
import ForumCommentItem from '../../components/Forum/ForumCommenItem';


const DownvotedComments = ({ navigation }) => {
    ...
    const useParentCallback = useCallback(() => {
        const fetchData = async () => {
            try {
                const forumComment = await getAllUserDownvotedForumComment(user.user.userId, false);
...
export default DownvotedComments;