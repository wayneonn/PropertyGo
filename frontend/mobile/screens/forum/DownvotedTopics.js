...
import { getAllUserDownvotedForumTopic, updateForumTopicFlaggedStatus, createForumTopic, deleteForumTopic } from '../../utils/forumTopicApi';
import AddForumTopicModal from '../../components/Forum/AddForumTopicModal';
import SearchBar from '../../components/Forum/SearchBar';

const DownvotedTopics = ({ navigation }) => {
  ...
  const useParentCallback = useCallback(() => {
    const fetchData = async () => {
      try {
        const forumTopicData = await getAllUserDownvotedForumTopic(user.user.userId, sort);
...
export default DownvotedTopics;
