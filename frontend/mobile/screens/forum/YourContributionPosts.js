...
import { getAllForumPostByUserId, updateForumPost, createForumPost, updateForumPostFlaggedStatus, deleteForumPost } from '../../utils/forumPostApi';
import AddForumPostModal from '../../components/Forum/AddForumPostModal';
import SearchBar from '../../components/Forum/SearchBar';

const YourContributionPosts = ({ navigation }) => {
...
//   const { topic } = route.params;
  ...
  const useParentCallback = useCallback(() => {
    const fetchData = async () => {
      try {
        const forumPostData = await getAllForumPostByUserId(user.user.userId, sort);
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View style={styles.header}>
          <Text style={styles.title}>Your Topic</Text>
...
export default YourContributionPosts;