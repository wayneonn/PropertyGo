...
import { getAllUserFlaggedForumTopic, updateForumTopicFlaggedStatus, createForumTopic, deleteForumTopic } from '../../utils/forumTopicApi';
import AddForumTopicModal from '../../components/Forum/AddForumTopicModal';
import SearchBar from '../../components/Forum/SearchBar';

const FlaggedTopics = ({ navigation }) => {
  ...
  const useParentCallback = useCallback(() => {
    const fetchData = async () => {
      try {
        const forumTopicData = await getAllUserFlaggedForumTopic(user.user.userId, sort);
