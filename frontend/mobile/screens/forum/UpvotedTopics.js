...
import { getAllUserUpvotedForumTopic, updateForumTopicFlaggedStatus, createForumTopic, deleteForumTopic } from '../../utils/forumTopicApi';
import AddForumTopicModal from '../../components/Forum/AddForumTopicModal';
import SearchBar from '../../components/Forum/SearchBar';

const UpvotedTopics = ({ navigation }) => {
  ...
  const useParentCallback = useCallback(() => {
    const fetchData = async () => {
      try {
        const forumTopicData = await getAllUserUpvotedForumTopic(user.user.userId, sort);
