    ...
    <View style={styles.container}>
      ...
      <View style={styles.profileInfo}>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.value}>{rating.userRating !== null ? rating.userRating.toFixed(1) : '0.0 [New User]'}</Text>
        </View>
        <View style={styles.ratingContainer}>
          ...
          <StarRating
            ...
            rating={rating.userRating !== null ? rating.userRating : 0}// The rating value (e.g., 4.5)
