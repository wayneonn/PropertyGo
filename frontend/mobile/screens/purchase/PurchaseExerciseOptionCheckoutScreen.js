...
import { updateTransaction, createOptionFeeTransaction, buyerPaidOptionExerciseFee } from '../../utils/transactionApi';
...
const PurchaseExerciseOptionCheckoutScreen = ({ route }) => {
    ...
    const openPaymentSheet = async () => {
        try {
            ...
            if (error) {
                ...
                navigation.navigate('Option Transaction Order Screen', { transactionId: data.transactionId });
            }
        } catch (error) {
...
export default PurchaseExerciseOptionCheckoutScreen;
