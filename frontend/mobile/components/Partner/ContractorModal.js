...
const ContractorModal = ({ modalVisible, setModalVisible, selectedContractor, handleChatWithContractor, modalImage, navigation }) => {
    return (
        <Modal
            animationType="slide"
            transparent={true}
            ...
            <View style={styles.centeredView}>
                <View style={styles.modalView}>
                    ...
                    <TouchableOpacity onPress={() => {
                        ...
                        navigation.navigate('View Profile', { userId: selectedContractor?.userId });
                        setModalVisible(!modalVisible);
                    }}>
                        {
                            (selectedContractor?.profileImage !== null && selectedContractor !== null) ? (
                                <Image
                                    source={{uri: `data:image/jpeg;base64,${selectedContractor.profileImage.data}`}}
                    ...
                    <Text style={styles.propertyDetails}>Project Completed: {selectedContractor?.projectsCompleted}</Text>
                    ...
                    >
                        ...
                        <Text style={styles.buttonText}>Chat With Contractor</Text>
                    </TouchableOpacity>
