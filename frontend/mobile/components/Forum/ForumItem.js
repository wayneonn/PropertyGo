...
import { getForumTopicVoteDetails, updateForumTopicVote } from '../../utils/forumTopicApi';

const ForumItem = ({ userId, topicId, topicName, postId, postTitle, postMessage, updatedAt, onPress, onReport}) => {
    ...
    return (
        <TouchableOpacity onPress={onPress}>
            ...
            <ForumModal isVisible={isModalVisible} onClose={toggleModal} onReport={onReport} />
        </TouchableOpacity>
    );
};
